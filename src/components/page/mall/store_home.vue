    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="hm-flex" style="padding: 20px;background: #fff;margin-bottom:2px; ">
                ...
                <div class="hm-flex"
                     style="width: 40px;flex-direction: column;align-items:center;font-size: 10px;padding-left: 10px;">
                        ...
                        <div class="hm-list-item" style="padding:0" @click="goodsClick(item.goods_id)">
                            <div class="hm-list-inner" style="padding:0">
                                ...
                                <div style="padding:.13rem .08rem .13rem .08rem;">
                                    <div class="hm-list-title-2 goods-name aui-ellipsis-2"
                                    ...
                                    <div class="hm-list-price hm-flex"
                                        ...
                                        <div class="" style="color: #ee2e3a;font-weight: 700;">
                                            <span>￥<b><strong
                                                    style="font-size:.48rem;">{{item.goods_price}}</strong></b></span>
                                        </div>
