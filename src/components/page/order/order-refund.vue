    ...
    <div class="page">
        <div class="page-content" v-show="init">
                ...
                <ul class="aui-list hm-margin-b" style="margin-bottom:10px;">
                    <li class="aui-list-item aui-list-item-middle" @click='choose_reason()'>
                        <div class="aui-list-item-inner ">
                            <div><span class="color-theme">*</span>&nbsp;选择
                                <template v-if="type=='tuikuan'">退款</template>
                                <template v-else>退货</template>
                                原因：{{reason}}
                            </div>
            ...
            <div style="padding: 10px;" v-show="!refund_applied">
                <div class="aui-btn aui-btn-danger aui-btn-block aui-btn-sm" @click="refund">申请<span
                        v-if="type=='tuikuan'">退款</span><span v-else>退货</span></div>
            </div>
