                ...
                <div class="scb-list" id="scbList" style="display: block;">
                    ...
                    <div class="scb-content" v-for="(store,key,index) in store_cart_list">
                        <p class="seller" v-if="address_info != null">
                            <i class="iconfont ion-ios-cart color-dark"></i><font color="#4a4a4a"> 宝贝由
                            {{store.store_name}} 发货</font>
                        ...
                        <div class="activate-box">
                            <input type="text" class="activate-key js-user-note" :name="key" v-model="pay_massage[key]"
                                   maxlength="50" placeholder="给卖家留言(50字以内)" autocomplete="off">
                        </div>
                    </div>
                    <div class="bg"></div>
                </div>
