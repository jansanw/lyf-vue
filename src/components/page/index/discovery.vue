                ...
                <div ref="top_menu" class="top-menu aui-border-b hm-flex-1">
                    <ul ref="top_menu_list" class="top-menu-list" :style="'width:'+m_w+'px'">
                        <li ref="top_menu_item" class="top-menu-item" :class="index==active?'active':''"
                            v-for="(item,index) in news_class" @click="changeMenu(index)">{{item.gc_name}}
                        </li>
                    </ul>
                </div>
                <a class="search-btn J_search-btn  aui-border-b"><i class="iconfont icon-sousuo"></i></a>
                <!--ion-search-->
            </div>


            <div class="news-list" style="margin-top: 45px;">
                <div class="news-item pic-wide aui-border-b" @click="go_news(111)">
                    <!-- 通栏宽图:加pic-wide，一张图:加pic-one，三张图:加pic-three-->
                ...
                <div class="news-item pic-three aui-border-b" @click="go_news(434)">
                    ...
                    <div class="news-pic">
                        <div class="pic-div"><img
                                src="https://gw.alicdn.com/imgextra/i4/31231784/TB2r70ioY_0UKFjy1XaXXbKfXXa_!!31231784-0-beehive-scenes.jpg_320x320q90s150.jpg">
                        </div>
                        <div class="pic-div"><img
                                src="https://gw.alicdn.com/imgextra/i1/2415696462/TB2U5qvww0kpuFjSspdXXX4YXXa_!!2415696462-0-daren.jpg_320x320q90s150.jpg">
                        </div>
                        <div class="pic-div"><img
                                src="https://gw.alicdn.com/imgextra/i3/3269846291/TB2beuxA98mpuFjSZFMXXaxpVXa_!!3269846291-0-beehive-scenes.jpg_320x320q90s150.jpg">
                        </div>
                    </div>
