                ...
                <div class="search-view-top">
                    <div class="view-top-container">
                        <div id="search-module-submit">
                            <input v-model="search_key" id="view-input" type="search" class="search-box-view-main"
                                   placeholder="输入商品名称/关键字">
                        </div>
...
//    LyfTabBar,
        ...
        methods: {
            ...
            _initScroll() {
                ...
                let items = this.$refs.root_list_item;
                //设置监听滚动位置
            ...
            _setListH() {
                let items = this.$refs.root_list_item;
                let items_r = this.$refs.detail_list_item;
                let a = 0;
                let b = 0;
