                                ...
                                <div class="tcont">
                                    ...
                                    <div class="state">
                                        ...
                                        <div class="state-cont">
                                            <p class="edit undefined" @click="edit_cart(store.store_id)">
                                                {{store.edit_text}}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="itemv2 edit-false" v-for="(goods,index) in store.goods">
                                                        ...
                                                        <div class="pay-price">
                                                          ...
                                                          <span class="major">{{goods.goods_price}}</span>
                                                            ...
                                                            <div class="originPrice">
                                                                <p>
                                                                    <del>￥{{goods.goods_marketprice}}</del>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="quantity">
                                ...
                                <div class="item-edit o-t-item undefined" style="background:#fff8f4;"
                                                ...
                                                <div class="edit-quantity">
                                                    ...
                                                    <p class="btn-input">
                                                        <input type="number" min="1"
                                                               v-on:blur="changeCount(store.store_id,index)"
                                                               v-model.number="goods.goods_num">
                                                    </p>
                                                    <p class="btn-plus">
                                                        <a @click="add_goods_num(store.store_id,index)" class="btn plus"
                                                           max="2"></a>
                                                    </p>
                                                </div>
                                                <div class="edit-sku">
                                    ...
                                    <div class="item-del c-edit-delshow"
                                         @click="del_cart(goods.cart_id,store.store_id,index)">
                                        <p>删除</p>
                                    </div>
                                </div>
                                <div class="op2"></div>
    ...
    export default {
        ...
        watch: {
            store_check_all: function (val, oldVal) {
                ...
                if (difference.length > 0 && this.is_c) {
                    for (let key in this.cart_list[difference[0]].goods) {
            ...
            cart_check_all: {
                get: function () {
                    ...
                    for (let k in this.cart_list) {
                        let g_all = 0;
                        let g_check = 0;
                        for (let key in this.cart_list[k].goods) {
                            all++;
                            g_all++;
        ...
        methods: {
            ...
            submit_cart() {
                if (this.total.num > 0) {
                    let cart_arr = [];
                    for (let store_id in this.cart_list) {
